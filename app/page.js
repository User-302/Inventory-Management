...
export default function Home() {
  ...
  //  add or remove items and update our local state
  const addItem = async (item, quantity) => {
    try {
      ...
      if (docSnap.exists()) {
        ...
        console.log(`Updating item ${item} from quantity ${existingQuantity} to ${existingQuantity + quantity}`);
        await setDoc(docRef, { quantity: existingQuantity + quantity });
      } else {
        console.log(`Adding new item ${item} with quantity ${quantity}`);
